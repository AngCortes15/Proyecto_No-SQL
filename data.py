...
def generate_dataset(output_file, rows):
    with open(output_file, "w") as fd:
        fieldnames = ["destination", "connection", "wait", "age", 
        "airline", "day", "gender" , "month","origin","passenger_id","reason", "stay", "transit", "year"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output",
            help="Specify the output filename of your csv, defaults to: flights.csv", default="flights.csv")
